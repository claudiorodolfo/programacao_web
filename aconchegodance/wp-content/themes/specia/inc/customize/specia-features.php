...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
    ...
    $wp_customize->add_setting( 
    	...
    	array(
			'default' 			=> esc_url(get_template_directory_uri() .'/images/features.jpg'),
			'capability'     	=> 'edit_theme_options',
...
function specia_home_feature_section_partials( $wp_customize ){
	...
	$wp_customize->selective_refresh->add_partial( 'features_title', array(
		...
		'render_callback'  => 'specia_features_title_render_callback',
	...
	$wp_customize->selective_refresh->add_partial( 'features_description', array(
		...
		'render_callback'  => 'specia_features_description_render_callback',
...
// features_title
function specia_features_title_render_callback() {
	return get_theme_mod( 'features_title' );
}
// features_description
function specia_features_description_render_callback() {
