...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	...
	'hs_social_tooltip' , 
		array(
			'label'          => __( 'Hide / Show Tooltip', 'specia' ),
			'section'        => 'header_setting',
			'type'           => 'radio',
			'choices'        => 
			array(
	...
	$wp_customize->add_section(
        ...
        array(
        	'priority'      => 4,
            'title' 		=> __('Header Cart & Button','specia'),
			'panel'  		=> 'header_section',
		)
    );
	...
	'header_cart' , 
		array(
			'label'          => __( 'Hide/ Show Header Cart', 'specia' ),
			'section'        => 'cart_button',
			'type'           => 'radio',
			'choices'        => 
			array(
	...
	'header_book_hide_show', 
		array(
			'label'	      => esc_html__( 'Hide/ Show Button', 'specia' ),
			'section'     => 'cart_button',
			'type'           => 'radio',
			'choices'        => 
			array(
	...
	$wp_customize->add_control( 
		'button_target',
		array(
		    'label'   		=> __('Open link in new tab','specia'),
		    'section' 		=> 'cart_button',
...
function specia_home_header_section_partials( $wp_customize ){
	...
	// button_label
	$wp_customize->selective_refresh->add_partial( 'button_label', array(
		'selector'            => '.header_btn a',
		'settings'            => 'button_label',
		'render_callback'  => 'specia_home_button_label_render_callback',	
	) );
	}
...
// button_label
function specia_home_button_label_render_callback() {
	return get_theme_mod( 'button_label' );
}