      ...
      <input type="hidden" 
        ...
        <div class="form-group">
          ...
          <textarea 
            ...
            id="endereco" 
            rows="3" 
            name="endereco">{{$pessoa->endereco}}</textarea>
        </div>                                   
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <select 
            ...
            name="turma_id_conduzido">   
              <option value=""></option>             
              @foreach($turmas as $turma)
                <option value="{{$turma->id}}" {{($pessoa->turma_id_conduzido == $turma->id) ? 'selected':''}}>{{$turma->nome}}</option>
              @endforeach
          </select>
        </div>  
        <div class="form-group">
        ...
        <a class="btn btn-danger" href="{{route('pessoa.index')}}">Cancelar</a>
      </form>
    </div>
  </body>
</html>